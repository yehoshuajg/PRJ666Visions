...
/*-------------------------- EMPLOYEE -----------------------------*/
insert into Employee (FirstName, LastName, Street, City, State_Province, PostalCode, HomePhone, CellPhone, Email, PositionID, JobType, UserName, Password, HireDate, TerminationDate) values ('Jean', 'Ross', '5 West Trail', 'Hamilton', 'Ontario', 'y9E 6h6', '658-082-9509', '714-792-6349', ‘jross@seneca.ca’, '4', 'Casual ', 'jross0', 'r', '2014-11-23', null);
insert into Employee (FirstName, LastName, Street, City, State_Province, PostalCode, HomePhone, CellPhone, Email, PositionID, JobType, UserName, Password, HireDate, TerminationDate) values ('Wayne', 'Chavez', '439 Almo Pass', 'Hamilton', 'Ontario', 'd0F 7V2', '827-631-4796', '597-451-9742', ‘wchavez1@seneca.ca’, '5', 'Part Time ', 'wchavez1', 'c', '2014-10-01', null);
