...
/*-------------------------- EMPLOYEE -----------------------------*/
insert into Employee (FirstName, LastName, Street, City, State_Province, PostalCode, HomePhone, CellPhone, Email, PositionID, JobType, UserName, Password, HireDate, TerminationDate) values ('Jean', 'Ross', '5 West Trail', 'Hamilton', 'Ontario', 'y9E 6h6', '8-658-082-9509', '2-714-792-6349', null, ‘5’, 'Casual ', 'jross0', 'r', '2014-11-23', null);
insert into Employee (FirstName, LastName, Street, City, State_Province, PostalCode, HomePhone, CellPhone, Email, PositionID, JobType, UserName, Password, HireDate, TerminationDate) values ('Wayne', 'Chavez', '439 Almo Pass', 'Hamilton', 'Ontario', 'd0F 7V2', '3-827-631-4796', '7-597-451-9742', null, ‘4’, 'Part Time ', 'wchavez1', 'c', '2014-10-01', null);
...
insert into Employee (FirstName, LastName, Street, City, State_Province, PostalCode, HomePhone, CellPhone, Email, PositionID, JobType, UserName, Password, HireDate, TerminationDate) values ('Andrew', 'Shaw', '87142 Maryland Avenue', 'Ajax', 'Ontario', 'H1a 2w5', null, '1-098-060-1922', 'ashaw4@devhub.com', ‘2’, 'Casual ', 'ashaw4', 'A', '2015-12-26', null);
